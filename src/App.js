    ...
    <>
      <nav className="navbar navbar-expand-lg navbar-dark" style={{ backgroundColor: "#000000" }}>
        <div className="container-fluid">
          <a href="https://felix-chow.netlify.app/" rel="home"><img style={{marginLeft: "100px"}} width="52" height="52" src="../images/Black-Pink-Bold-Elegant-Monogram-Personal-Brand-Logo-1-e1681776583474.png" alt=""/></a>
